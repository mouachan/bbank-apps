...
export declare const OutlinedIdCardIconConfig: {
...
export declare const OutlinedIdCardIcon: React.ComponentClass<SVGIconProps>;
export default OutlinedIdCardIcon;