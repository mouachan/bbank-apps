...
export declare const OutlinedFileCodeIconConfig: {
...
export declare const OutlinedFileCodeIcon: React.ComponentClass<SVGIconProps>;
export default OutlinedFileCodeIcon;