...
export declare const SortNumericDownIconConfig: {
...
export declare const SortNumericDownIcon: React.ComponentClass<SVGIconProps>;
export default SortNumericDownIcon;