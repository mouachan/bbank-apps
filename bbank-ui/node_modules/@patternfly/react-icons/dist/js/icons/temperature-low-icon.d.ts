...
export declare const TemperatureLowIconConfig: {
...
export declare const TemperatureLowIcon: React.ComponentClass<SVGIconProps>;
export default TemperatureLowIcon;