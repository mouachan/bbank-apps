...
export declare const SortAlphaDownAltIconConfig: {
...
export declare const SortAlphaDownAltIcon: React.ComponentClass<SVGIconProps>;
export default SortAlphaDownAltIcon;