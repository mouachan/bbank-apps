...
export declare const OutlinedGrinAltIconConfig: {
...
export declare const OutlinedGrinAltIcon: React.ComponentClass<SVGIconProps>;
export default OutlinedGrinAltIcon;