...
export declare const OutlinedSmileWinkIconConfig: {
...
export declare const OutlinedSmileWinkIcon: React.ComponentClass<SVGIconProps>;
export default OutlinedSmileWinkIcon;