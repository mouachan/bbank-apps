...
export declare const OutlinedGrimaceIconConfig: {
...
export declare const OutlinedGrimaceIcon: React.ComponentClass<SVGIconProps>;
export default OutlinedGrimaceIcon;