...
export declare const OutlinedFlushedIconConfig: {
...
export declare const OutlinedFlushedIcon: React.ComponentClass<SVGIconProps>;
export default OutlinedFlushedIcon;