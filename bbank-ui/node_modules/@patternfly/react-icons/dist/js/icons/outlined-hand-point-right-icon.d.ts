...
export declare const OutlinedHandPointRightIconConfig: {
...
export declare const OutlinedHandPointRightIcon: React.ComponentClass<SVGIconProps>;
export default OutlinedHandPointRightIcon;