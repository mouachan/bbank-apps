...
export declare const PficonSortCommonDescIconConfig: {
...
export declare const PficonSortCommonDescIcon: React.ComponentClass<SVGIconProps>;
export default PficonSortCommonDescIcon;