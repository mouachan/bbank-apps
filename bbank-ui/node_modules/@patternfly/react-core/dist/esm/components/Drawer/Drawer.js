...
export const Drawer = (_a) => {
    var { className = '', children, isExpanded = false, isInline = false, isStatic = false, position = 'right', onMount = () => { }, onUnmount = () => { } } = _a, props = __rest(_a, ["className", "children", "isExpanded", "isInline", "isStatic", "position", "onMount", "onUnmount"]);
    React.useEffect(() => {
        onMount();
        return () => {
            onUnmount();
