...
export class Nav extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(NavContext.Provider, { value: {
            ...
            React.createElement("nav", Object.assign({ className: css(styles.nav, theme === 'light' && styles.modifiers.light, isHorizontal && styles.modifiers.horizontal, variant === 'tertiary' && styles.modifiers.tertiary, this.state.isScrollable && styles.modifiers.scrollable, className), "aria-label": ariaLabel || variant === 'tertiary' ? 'Local' : 'Global' }, getOUIAProps(Nav.displayName, ouiaId, ouiaSafe), props), children)));
    }
}
Nav.displayName = 'Nav';
Nav.defaultProps = {
