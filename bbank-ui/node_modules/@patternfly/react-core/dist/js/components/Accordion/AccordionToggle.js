...
exports.AccordionToggle = (_a) => {
    ...
    return (React.createElement(AccordionContext_1.AccordionContext.Consumer, null, ({ ToggleContainer }) => {
        ...
        return (React.createElement(Container, null,
            React.createElement("button", Object.assign({ id: id, className: react_styles_1.css(accordion_1.default.accordionToggle, isExpanded && accordion_1.default.modifiers.expanded, className) }, props, { "aria-expanded": isExpanded }),
