...
class ToolbarFilter extends React.Component {
    ...
    render() {
        const _a = this.props, { children, chips, deleteChipGroup, deleteChip, categoryName, showToolbarItem } = _a, props = tslib_1.__rest(_a, ["children", "chips", "deleteChipGroup", "deleteChip", "categoryName", "showToolbarItem"]);
        ...
        const chipGroup = chips.length ? (React.createElement(ToolbarItem_1.ToolbarItem, { variant: "chip-group" },
            React.createElement(ChipGroup_1.ChipGroup, { key: typeof categoryName === 'string' ? categoryName : categoryName.key, categoryName: typeof categoryName === 'string' ? categoryName : categoryName.name, isClosable: deleteChipGroup !== undefined, onClick: () => deleteChipGroup(categoryName) }, chips.map(chip => typeof chip === 'string' ? (React.createElement(ChipGroup_1.Chip, { key: chip, onClick: () => deleteChip(categoryName, chip) }, chip)) : (React.createElement(ChipGroup_1.Chip, { key: chip.key, onClick: () => deleteChip(categoryName, chip) }, chip.node)))))) : null;
