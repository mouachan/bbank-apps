@charset "UTF-8";
.pf-t-light, .pf-c-accordion, .pf-c-alert, .pf-c-banner.pf-m-info, .pf-c-banner.pf-m-warning, .pf-c-chip, .pf-c-chip-group, .pf-c-context-selector__menu, .pf-c-data-list, .pf-c-form-control, .pf-c-input-group, .pf-c-page__sidebar.pf-m-light, .pf-c-select, .pf-c-table {
...
.pf-c-drawer {
  ...
  .pf-c-drawer.pf-m-inline .pf-c-drawer__panel:not(.pf-m-no-border), .pf-c-drawer.pf-m-static .pf-c-drawer__panel:not(.pf-m-no-border) {
...
@media screen and (min-width: 768px) {
  ...
  .pf-c-drawer.pf-m-panel-left .pf-c-drawer__panel {
    ...
    transform: translateX(-100%); }
  .pf-c-drawer.pf-m-panel-left.pf-m-inline .pf-c-drawer__panel:not(.pf-m-no-border), .pf-c-drawer.pf-m-panel-left.pf-m-static .pf-c-drawer__panel:not(.pf-m-no-border) {
...
.pf-c-dropdown {
  ...
  --pf-c-dropdown__menu-item-description--Color: var(--pf-global--Color--200);
