...
export declare const OutlinedCalendarPlusIconConfig: {
...
export declare const OutlinedCalendarPlusIcon: React.ComponentClass<SVGIconProps>;
export default OutlinedCalendarPlusIcon;