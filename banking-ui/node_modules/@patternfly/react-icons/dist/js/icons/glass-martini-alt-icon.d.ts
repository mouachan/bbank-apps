...
export declare const GlassMartiniAltIconConfig: {
...
export declare const GlassMartiniAltIcon: React.ComponentClass<SVGIconProps>;
export default GlassMartiniAltIcon;