...
export declare const OutlinedFrownOpenIconConfig: {
...
export declare const OutlinedFrownOpenIcon: React.ComponentClass<SVGIconProps>;
export default OutlinedFrownOpenIcon;