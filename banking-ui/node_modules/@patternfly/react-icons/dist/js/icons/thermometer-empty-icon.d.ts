...
export declare const ThermometerEmptyIconConfig: {
...
export declare const ThermometerEmptyIcon: React.ComponentClass<SVGIconProps>;
export default ThermometerEmptyIcon;