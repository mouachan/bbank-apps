...
export declare const PficonSortCommonAscIconConfig: {
...
export declare const PficonSortCommonAscIcon: React.ComponentClass<SVGIconProps>;
export default PficonSortCommonAscIcon;