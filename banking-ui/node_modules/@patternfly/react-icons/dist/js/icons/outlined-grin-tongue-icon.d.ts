...
export declare const OutlinedGrinTongueIconConfig: {
...
export declare const OutlinedGrinTongueIcon: React.ComponentClass<SVGIconProps>;
export default OutlinedGrinTongueIcon;