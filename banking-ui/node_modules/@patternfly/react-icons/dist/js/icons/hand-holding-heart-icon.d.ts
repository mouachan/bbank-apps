...
export declare const HandHoldingHeartIconConfig: {
...
export declare const HandHoldingHeartIcon: React.ComponentClass<SVGIconProps>;
export default HandHoldingHeartIcon;