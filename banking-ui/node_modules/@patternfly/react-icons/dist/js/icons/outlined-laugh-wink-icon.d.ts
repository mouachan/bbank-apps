...
export declare const OutlinedLaughWinkIconConfig: {
...
export declare const OutlinedLaughWinkIcon: React.ComponentClass<SVGIconProps>;
export default OutlinedLaughWinkIcon;